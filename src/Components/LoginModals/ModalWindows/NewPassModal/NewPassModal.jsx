...
import {
  ...
  openSuccessReset,
  closeNewPass,
  selectNewPasswordModalNewPass,
  setNewPasswordModalNewPass,
  selectConfirmPasswordModalNewPass,
...
function NewPassModal() {
  ...
  const newPassword = useSelector(selectNewPasswordModalNewPass);
    ...
    <div className={`modal-wrapper ${isOpen ? "open" : "close"}`}>
      <form className="modal reset-pass__container">
        ...
        <Input
          ...
          isPassword={true}
          value={newPassword}
          setValue={setNewPasswordModalNewPass}
        ></Input>
        <Input
          ...
          setValue={setConfirmPasswordModalNewPass}
        ></Input>
        <PrimaryBtn
          className="primary-btn"
          onClick={() => {
            dispatch(closeNewPass());
            dispatch(openSuccessReset());
          }}
        >
          Reset Password
        </PrimaryBtn>
